...
public class VEOError extends Exception {
    ...
    /**
     * Construct a new VEOError from a class constructor giving error number and an exception
     * 
     * @param classname name of class and method generating the error (must not be null)
     * @param errno unique error number (must be > 0)
     * @param s error message
    ...
    /**
     * Construct a new VEOError from a particular method giving error number and an exception
     * 
     * @param classname name of class and method generating the error (must not be null)
     * @param method method generating error within the class (may be null)
     * @param errno unique error number (must be > 0)
    ...
    /**
     * Construct a standard format error message. This static method is used when
    ...
    /**
     * Turn the classname, method, and errno into a unique identifier for this error
     * 
     * @param classname name of class and method generating the error (must not be null)
     * @param method method generating error within the class (may be null)
     * @param errno unique error number (must be > 0)
